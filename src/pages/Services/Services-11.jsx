...
export default function OutdoorAdvertising() {
  ...
  return (
    <>
      <Head>
        <title>Outdoor Advertising & OOH | Visuura</title>
        <meta
          name="description"
          content="Dominate the physical world with high-impact Out-of-Home (OOH) advertising, digital billboards, and transit media."
        />
      </Head>
