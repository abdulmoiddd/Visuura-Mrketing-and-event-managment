...
export default function PhotographyVideography() {
  ...
  return (
    <>
      <Head>
        <title>Photography & Videography | Visuura</title>
        <meta
          name="description"
          content="Cinematic video production and high-end commercial photography to capture your brand's true narrative."
        />
      </Head>
