...
export default function SeoServices() {
  ...
  return (
    <>
      <SEO
        title="SEO Services & Organic Growth | Visuura"
        description="Data-driven Search Engine Optimization to dominate rankings and drive targeted organic revenue."
        path="/Services/Services-6"
      />
