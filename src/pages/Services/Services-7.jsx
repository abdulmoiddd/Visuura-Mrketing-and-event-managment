...
export default function GoogleAds() {
  ...
  return (
    <>
      <SEO
        title="Google Ads & PPC Management | Visuura"
        description="Data-driven Google Ads management focused on maximizing your Return on Ad Spend (ROAS) and driving high-intent leads."
        path="/Services/Services-7"
      />
