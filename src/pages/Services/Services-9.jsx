...
export default function AppDevelopment() {
  ...
  return (
    <>
      <SEO
        title="Mobile App Development | Visuura"
        description="Custom iOS and Android application development. We build scalable, intuitive apps designed for high engagement."
        path="/Services/Services-9"
      />
