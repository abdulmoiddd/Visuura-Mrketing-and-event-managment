...
export default function EcommerceDevelopment() {
  ...
  return (
    <>
      <SEO
        title="E-Commerce Development | Visuura"
        description="High-converting digital storefronts. We build scalable, secure, and blazing-fast e-commerce platforms."
        path="/Services/Services-8"
      />
