...
export default function Home() {
  return (
    <>
      <SEO 
  title="Our Portfolio | Visuura" 
  description="Explore our past digital agency results, graphic design work, and event management production milestones across Pakistan."
  path="/portfolio"
/>
