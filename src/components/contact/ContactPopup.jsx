...
import VisitingCardPopup from "@/components/contact/VisitingCardPopup";
          ...
          <div className="relative z-10 space-y-8">
            <div>
              ...
              <p className="mt-4 text-white/70 text-sm">
                Click or scan the QR code to instantly save our contact details,
